"""
AMD ADL (Display Library) Direct Binding - ADL2 API
====================================================
Low-level ctypes binding to atiadlxx.dll for GPU monitoring on Windows.
Uses ADL2 API (newer version with context handle).
...
NOTE: This is a utility module used by pdh_backend.py for supplemental
temperature/fan readings. It is NOT a full MonitorBackend implementation.
For the ADL1-based backend, see adl_backend.py.
"""
...
class ADLContext:
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            self.available = True
            logger.info(f"ADL: Initialized â€” {len(self.adapters)} adapter(s)")
            return True
