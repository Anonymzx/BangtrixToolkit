...
class AMDMonitorServer:
    ...
    def _build_stats_data(self, monitor, gpu_id: int = 0):
        ...
        data = {
            ...
            "vram_usage_pct": round(stats.utilization_memory, 1),
            "vram_used_mb": round(stats.memory_used / (1024 * 1024), 0),
            "vram_total_mb": round(stats.memory_total / (1024 * 1024), 0),
            "temperature": round(stats.temperature, 1),
            "fan_speed": stats.fan_speed,
            "core_clock_mhz": stats.core_clock,
            "memory_clock_mhz": stats.memory_clock,
            "power_draw_watts": round(stats.power_draw, 1),
            "history": list(self.gpu_history.get(gpu_id, [])),
        }
